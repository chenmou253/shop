...
func (ContentPage) TableName() string { return "content_pages" }
...
func (ContentArticle) TableName() string { return "content_articles" }
...
func (EmailSubscriber) TableName() string { return "email_subscribers" }
